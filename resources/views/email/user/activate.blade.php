	...
	<div class="body-wrap">
		...
		<div class="container" bgcolor="#FFFFFF">
			...
			<div class="content">
				...
				<p style="margin:25px 0"><a href="{{url('/user/auth/register/activate/'.$token)}}" class="btn-primary">Verify Email</a></p>
				<p>Please click on link below if the above button doesn't work.</p>
				<p><a class="no-wrap" href="{{url('/user/auth/register/activate/'.$token)}}">{{url('/user/auth/register/activate/'.$token)}}</a></p>
			</div>
			<!-- /content -->
			<div class="footer">
