...
<div class="row">
        ...
        <h3>Add {{ $collection->collection_name }} Products</h3>
        <div class="row">
            <div class="col-md-6 pr-md-1">
            @csrf
            <input type="hidden" id="colid" name="collection_id" value="{{ $collection->collection_id }}">
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Choose Product Category</label>
                    <select class="selectpicker" data-live-search="true" id="cat_id" name="category_id" data-style="btn btn-primary btn-round" title="Select Product Category" data-size="3">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="content-view">
                    <div class="material-datatables">
                    <form action="{{ route('admin.add-collection-products') }}" method="post">
                        @csrf 
    ...
    <script>
        ...
        $(document).ready(function(){
            $('#cat_id').on('change',function(){
                ...
                var colid = $('#colid').val();
                document.getElementById('pro').innerHTML = "<tbody id='pro'> </tbody>";
                //console.log(catid);
                $.ajax({
                    type: 'post',
                    url: '/admin/get-category-products',
                    data: { '_token': $('input[name=_token]').val(),'cat_id' : catid, 'collection_id' : colid },
